		...
		@foreach($products as $product)
			<li class="item">
				<div class="product-img">
					<a href="shop-ui-inner.html"><img class="full-width img-responsive" src="{{asset('assets/img/products/'.$product->slug.'.webp')}}" alt=""></a>
				...
				<div class="product-description product-description-brd">
					<div class="overflow-h margin-bottom-5">
						<div class="pull-left">
							<h4 class="title-price"><a href="shop-ui-inner.html">{{$product->name}}</a></h4>
